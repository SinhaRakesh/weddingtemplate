(function($) {
	...
	//Price Range Slider / Header Search
	if($('.range-slider-one').length){

		var priceRange = document.getElementById('range-slider-one');
		...
		var limitFieldMin = document.getElementById('min-value-price');
		var limitFieldMax = document.getElementById('max-value-price');
